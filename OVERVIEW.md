...
このリポジトリは、構造持続理論に関する `v2` の主理論 spine 3 本と Route C companion 2 本を中心に読むための構成です。
...
3. [`v2/3_構造持続の収支原理と崩壊傾向.md`](v2/3_構造持続の収支原理と崩壊傾向.md)
   閉じた系の `S = M e^{-L}` を、回復量を含む開いた系の `S = M e^{-B}` へ拡張する主理論 spine の第三層。
...
- [`v2/pdf用/3_構造持続の収支原理と崩壊傾向.pdf`](v2/pdf用/3_構造持続の収支原理と崩壊傾向.pdf)
