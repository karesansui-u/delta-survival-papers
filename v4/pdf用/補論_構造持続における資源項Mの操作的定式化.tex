...
\subsection{\texorpdfstring{有効資源と集約関数 \(\Phi\)}{有効資源と集約関数 \textbackslash Phi}}\label{ux6709ux52b9ux8cc7ux6e90ux3068ux96c6ux7d04ux95a2ux6570-phi}
...
本補論の維持能力成分の分解は、\texttt{Survival/MaintenanceComponentDecomposition.lean} で形式化されている。Lean 側で閉じているのは、経験的な観測・推定指標の妥当性ではなく、M 側の表現文法と、M interface 上の表現定理である。
...
\section{\texorpdfstring{Software contract-coherence diagnostics、SAT、Mixed-CSP の \(M\)-component 解釈は本節では扱わない。これらは §5-6 または別稿で扱う。}{Software contract-coherence diagnostics、SAT、Mixed-CSP の M-component 解釈は本節では扱わない。これらは §5-6 または別稿で扱う。}}\label{software-contract-coherence-diagnosticssatmixed-csp-ux306e-m-component-ux89e3ux91c8ux306fux672cux7bc0ux3067ux306fux6271ux308fux306aux3044ux3053ux308cux3089ux306f-5-6-ux307eux305fux306fux5225ux7a3fux3067ux6271ux3046}
...
\item
  DeltaLint 実装による既存実績だけで本補論が実証されたとは主張しない。Software contract-coherence diagnostics は本補論の主 validation から切り離し、LLM companion I / L-side の static-code extension として別 note で扱う。
\item
...
\item
  Software contract-coherence diagnostics が本補論の validation であるとは主張しない。
\item
...
\item
  \(F / \Sigma / R / M\) の操作的分解。
\item
  software / SaaS における任意の component-based M diagnostic validation。
\item
