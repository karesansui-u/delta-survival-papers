...
Lean 形式化版では、この必然性定理を G1 としてまとめています。この定理は、文法が単なる便利な記法ではなく、明示された
