...
このリポジトリの主対象は、`v2` にある主理論 spine 2 本、統合版、Route C companion 2 本、および補論群です。

- 最短導線: [`v2/0_構造持続理論の統合版.md`](v2/0_%E6%A7%8B%E9%80%A0%E6%8C%81%E7%B6%9A%E7%90%86%E8%AB%96%E3%81%AE%E7%B5%B1%E5%90%88%E7%89%88.md) -> [`v2/2_構造持続の収支原理.md`](v2/2_構造持続の収支原理.md)
- 主理論 spine: `v2/1` -> `v2/2`
...
4. [`v2/補論_構造持続の条件つき導出.md`](v2/補論_構造持続の条件つき導出.md)
