...
必然性定理、持続・停止・崩壊計算の必要文法、少数の強い適用例に
集中してください。
...
**外向け1枚（LLM 三問題）:** [delta-zero/docs/llm_triad_one_pager_ja.md](https://github.com/karesansui-u/delta-zero/blob/main/docs/llm_triad_one_pager_ja.md)
