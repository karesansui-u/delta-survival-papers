...
structural balance amount \(B_n=\sum_{t<n}b_t\) & \texttt{StructuralPersistenceBalancePrinciple.cumulativeBalance\_eq\_sum\_oneStepBalance} & finite-prefix sum として証明済み \\
