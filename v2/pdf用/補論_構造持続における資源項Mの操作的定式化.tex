...
\subsection{LLM companion I / II との概観的接続}\label{llm-companion-i-ii-ux3068ux306eux6982ux89b3ux7684ux63a5ux7d9a}
...
\section{LLM companion I / II の成分対応}\label{llm-companion-i-ii-ux306eux6210ux5206ux5bfeux5fdc}
...
\subsection{LLM companion I: 推論時矛盾と外部代謝}\label{llm-companion-i-ux63a8ux8ad6ux6642ux77dbux76feux3068ux5916ux90e8ux4ee3ux8b1d}
...
\subsection{LLM companion II: LoRA 継続学習と依存再編}\label{llm-companion-ii-lora-ux7d99ux7d9aux5b66ux7fd2ux3068ux4f9dux5b58ux518dux7de8}
...
\subsection{LLM companion II §7.5 の三役分離との接続}\label{llm-companion-ii-7.5-ux306eux4e09ux5f79ux5206ux96e2ux3068ux306eux63a5ux7d9a}
...
\def\labelenumi{\arabic{enumi}.}
\item
  Software / SaaS が仕様固定構造層であるとは主張しない。
\item
  \(\hat L\) が真の \(L\) と同一であるとは主張しない。
\item
  \(M_i\) が単一の universal metric で測れるとは主張しない。
\item
  DeltaLint の既存実績だけで本補論が実証されたとは主張しない。DeltaLint は本補論の主 validation から切り離し、LLM companion I / L-side の static-code extension として別 note で扱う。
\item
...
\item
  \(F / \Sigma / R / M\) の操作的分解。
\item
  software / SaaS における component-based M-profile validation と、下流の intervention-ranking hypothesis。
\item
  それらを検査するための preregistered validation protocol。
\end{enumerate}
...
\subsection{Software は構造推定層であり仕様固定構造層ではない}\label{software-ux306fux69cbux9020ux63a8ux5b9aux5c64ux3067ux3042ux308aux4ed5ux69d8ux56faux5b9aux69cbux9020ux5c64ux3067ux306fux306aux3044}
