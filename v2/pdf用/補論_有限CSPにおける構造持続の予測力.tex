...
\item
  Bootstrap percolation や branching process がこの意味で仕様固定構造ドメイン anchor である、とは主張しない。
\item
...
\texttt{analysis/exp43\_qcoloring/exp43c\_true\_outside\_rerun\_01\_philia\_channel.md} & first returned true outside-group rerun \\
\texttt{analysis/exp43\_qcoloring/exp43c\_true\_outside\_rerun\_02\_katsumasa1234.md} & second returned true outside-group rerun \\
\texttt{analysis/exp43\_qcoloring/exp43c\_true\_outside\_rerun\_03\_SCRAPRO.md} & third returned true outside-group rerun \\
\texttt{analysis/exp43\_qcoloring/exp43c\_true\_outside\_final\_report.md} & final outside-group rerun report \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
Mixed-CSP & \texttt{3} & \texttt{3/3} clean success \\
Exp43c q-coloring & \texttt{3} & \texttt{3/3} returned clean success \\
\end{longtable}
}
