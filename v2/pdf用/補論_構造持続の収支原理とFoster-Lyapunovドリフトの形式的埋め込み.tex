...
本稿群では、既存理論との接続を G6-a / G6-b / G6-c の三段階に分ける。この分類は主論文本文の主線ではなく、運用規律および詳細展開補論に置かれた接続強度の整理である。熱力学や情報理論との対応は、多くの場合 G6-a または G6-b に留まる。一方、queueing theory や Markov chain stability に現れる Foster-Lyapunov drift 条件は、構造持続の収支原理の純消耗量 \(b_{t}\) へ直接埋め込める。
