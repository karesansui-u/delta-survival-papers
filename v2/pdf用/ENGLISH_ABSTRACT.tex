...
\vspace{0.5em}
{\small Akihito Sunagawa \quad April 29, 2026\par}
\end{center}
\vspace{0.8em}
...
The current Lean 4 formalization contains 151 \texttt{Survival} modules with \texttt{sorry = 0} and \texttt{axiom = 0}. Its strongest cross-class statement is deliberately limited: Phase 7 v2 registers Bernoulli-CSP, Foster-Lyapunov / queueing, and Repair-Maintenance as limited classes that instantiate a common structural-persistence interface. This is not a single universal inequality over arbitrary domains; it is an extensible interface closure for registered classes.
