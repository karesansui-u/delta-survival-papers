...
| failure mode | proxy miss / weak-axis / leakage risk / small sample / no natural \(r_t\) / no fresh surface など |
...
- observability / logging: 構造消耗量と回復量を後から測れるようにし、\(L\), \(r_t\), margin の代理指標を残す。
