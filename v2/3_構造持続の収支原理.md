...
1. 構造持続の最小形式: loss-only の最小形式。
2. 構造持続の条件つき導出: 条件つき導出と弱依存境界。
3. 本稿: 構造消耗量と回復量を含む構造持続の収支原理。
