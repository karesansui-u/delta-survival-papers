...
| Route A non-CSP core examples | `SerialReliability` | Serial reliability block diagrams, additive log loss, and `R = exp (-L)` threshold crossing |
