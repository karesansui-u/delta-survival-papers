#!/usr/bin/env python3
"""Emit a JSONL output template for the frozen premise-update protocol.
...
and adds placeholder fields for raw baseline / controlled outputs.

It does not call a model and does not produce a scored result.
"""
