...
Status: after Exp43c q-coloring primary validation and G4 v2 repair-maintenance integration.
...
| G4 non-CSP | G4 v1/v2 minimal skeletons closed | Optional stochastic reliability / maintenance-log pilot, with explicit scope lock |
