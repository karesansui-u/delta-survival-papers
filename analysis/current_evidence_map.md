...
| G4 non-CSP | G4 v1/v2 minimal skeletons closed; repair-flow public dataset search paused; Backblaze loss-only primary completed with no support under frozen log-loss rule | Next clean move: do not rescue Backblaze post-hoc; use `analysis/backblaze_loss_only_v2_exploration_note.md` as the design boundary, `analysis/backblaze_loss_only_v2_archive_ranking_note.md` as the metadata-only ranking, `analysis/g4_backblaze_q3_2025_archive_feasibility_note.md` as the fresh-archive feasibility check, `analysis/backblaze_loss_only_v2_preregistration_draft.md` as the current Q3 2025 calibration-aware prereg draft, and `analysis/backblaze_loss_only_v2/freeze_manifest_draft.md` as the current freeze-manifest candidate |
