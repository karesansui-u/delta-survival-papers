...
| Epistemic-control protocol chain | `EpistemicControlBridge*`, `EpistemicBenchmarkProtocol.lean`, `EpistemicBenchmarkResultCertificate.lean`, `SoftwareEvidenceNetActionBridge.lean`, `analysis/epistemic_control_frozen_toy_v0/run_eval.py`, `v3/05_evidence/llm_epistemic_control_frozen_toy_v0/llm_epistemic_control_frozen_toy_v0_result_001.json` | Assumption-to-guarantee chain plus deterministic toy result artifact | If explicit finite witnesses are supplied, the protocol and result-certificate layers invoke the no-worse-net-action / coherent-mass comparison theorem | LLM semantics, real model performance, benchmark validity, memory safety, or workflow correctness |
