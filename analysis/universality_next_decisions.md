...
q-coloring primary validation, and the completed three-run Mixed-CSP true
...
Independent replication has a completed three-run Mixed-CSP outside-group
rerun set and one clean Exp43c outside-group return; further heterogeneous
...
4. Review and polish the structural persistence balance principle / 構造持続の収支原理 draft as the next
   ...
   `v2/3_構造持続の収支原理.md`; current control memo:
...
18. Exp43c now also has its first returned true outside-group rerun at
    `analysis/exp43_qcoloring/exp43c_true_outside_rerun_01_philia_channel.md`.
19. Treat q-coloring and Cardinality-SAT as optional Route A width extensions,
