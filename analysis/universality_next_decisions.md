...
14. For the next cross-domain non-CSP empirical move, treat
    ...
    exact public archive acquisition and
    ...
    current hardening surface; keep all five explicitly below repair-flow
    evidence.
