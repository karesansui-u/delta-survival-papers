...
and defect-controlled compatibility Lean wrappers.
...
- The admissible-maps / hierarchical-invariants supplement now makes the
  ...
  `Survival.SaturationDefect`, `Survival.AdmissibleMapCompatibility`, and
  `Survival.DefectControlledAdmissibleMap`.
