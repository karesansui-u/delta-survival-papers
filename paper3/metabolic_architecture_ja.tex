...
\subsection{Sonnetの例外}

Sonnet~4.6は矛盾下で劣化ゼロを示す唯一のテスト済みモデルである。
これは矛盾耐性がモデル重み内で達成可能であることを示す。
しかしSonnetの耐性は受動的であり、矛盾を管理せずに容認する。
矛盾耐性を持たない5/6モデルに対して、外部代謝はモデル非依存の解決策を提供する。
