...
| 2026-05-27 | OSF | Lean epistemic-control bridge and baseline-comparison focused bundle | `https://files.us.osf.io/v1/resources/mdh7b/providers/osfstorage/6a161bc474938d61d7cc7274` | pending | `8a79fda07f12e8eebf24205e4a9a236bd42ec2fd` | `lean_epistemic_control_bridge_2026-05-27_8a79fda.zip` | `sha256:83af14e2ec5ee0e3e8bdbbb123b18d049c760af97683d02985a78f1b9326f6f0` | Uploaded via OSF / WaterButler API to project `mdh7b`; OSF file id `osfstorage/6a161bc474938d61d7cc7274`; size `146023` bytes; OSF-reported sha256 matched local archive; focused bundle includes the finite epistemic-control bridge stack, comparison layer, toy LLM-style and software-contract instantiations, and reader-facing claim-boundary docs, not the full `v3/` directory |
