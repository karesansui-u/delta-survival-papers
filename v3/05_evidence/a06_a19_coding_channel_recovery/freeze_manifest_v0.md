A06/A19 Coding-Channel Recovery Freeze Manifest v0
==================================================
...
manifest_id: coding_channel_recovery_v0
...
The predecessor was a smoke run only. It is not evidence. This v0 package uses
an independently seeded support-bearing surface and cannot reinterpret the
smoke output as validation evidence.
...
> unique-recovery failure better than \(B1\) alone.

Claim strength if passed:

- finite synthetic A06/A19-v0 support for low-order parity-check
  column-dependency pressure;
- support only for the frozen BEC, sparse parity-check, rate-0.50,
...
```text
05_evidence/a06_a19_coding_channel_recovery/primary_v0
```
...
python3 -B 05_evidence/a06_a19_coding_channel_recovery/scripts/generate_smoke.py \
  --output-dir 05_evidence/a06_a19_coding_channel_recovery/primary_v0 \
  --n-values 24,32 \
  --rates 0.50 \
  --column-weight 3 \
  --q-values 0.18,0.24,0.30,0.36 \
...
python3 -B 05_evidence/a06_a19_coding_channel_recovery/scripts/evaluate_smoke.py \
  --input-dir 05_evidence/a06_a19_coding_channel_recovery/primary_v0 \
  --output-dir 05_evidence/a06_a19_coding_channel_recovery/primary_v0 \
