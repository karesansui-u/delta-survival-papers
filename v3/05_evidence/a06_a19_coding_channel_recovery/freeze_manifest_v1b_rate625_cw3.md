A06/A19 Coding-Channel Recovery Freeze Manifest v1b Rate-0.625 CW3
===================================================================
...
manifest_id: coding_channel_recovery_v1b_rate625_cw3
...
05_evidence/a06_a19_coding_channel_recovery/primary_v1_rate625_cw4_invalid_run_summary.md
```

The predecessor primary_v0 passed on a rate-0.50, column-weight-3 surface. The
predecessor v1 rate-0.625, column-weight-4 surface was invalid because fixed
even column weight prevents full row rank in the current exact-column-weight
generator. This v1b package is an independently seeded successor surface, not a
rescue or reinterpretation of either predecessor.
...
> column-weight-3 surface.

Claim strength if passed:

- finite synthetic A06/A19-v1b support for low-order parity-check
  column-dependency pressure;
- independent successor support beyond the rate-0.50 v0 surface;
...
```text
05_evidence/a06_a19_coding_channel_recovery/primary_v1b_rate625_cw3
```
...
python3 -B 05_evidence/a06_a19_coding_channel_recovery/scripts/generate_smoke.py \
  --output-dir 05_evidence/a06_a19_coding_channel_recovery/primary_v1b_rate625_cw3 \
  --n-values 32,40 \
  --rates 0.625 \
  --column-weight 3 \
  --q-values 0.16,0.22,0.28,0.34 \
...
python3 -B 05_evidence/a06_a19_coding_channel_recovery/scripts/evaluate_smoke.py \
  --input-dir 05_evidence/a06_a19_coding_channel_recovery/primary_v1b_rate625_cw3 \
  --output-dir 05_evidence/a06_a19_coding_channel_recovery/primary_v1b_rate625_cw3 \
  --c-grid 0.01,0.1,1,10 \
  --bootstrap-replicates 1000 \
  --bootstrap-seed 102241
```
