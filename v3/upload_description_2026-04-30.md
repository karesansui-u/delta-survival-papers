...
Source commit and archive checksum are recorded per upload in `UPLOAD_RECORDS.md`.
...
```text
Structural Persistence Theory v3 public working structure. See UPLOAD_RECORDS.md
for the source commit and archive checksum of the cited upload.
```
