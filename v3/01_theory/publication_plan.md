...
| `21_public_second_draft_outline.md` | 公開第二稿の章立て候補。推定レイヤー、凍結検証、支持・非支持・沈黙、失敗台帳の編集地図 |
...
現時点の本文候補は `22_public_second_draft.md` に置く。このファイルは `21_public_second_draft_outline.md` の章立てを本文化したものであり、まだ新しい支持判定や実験結果を追加するものではない。


5. 公開第二稿の素材対応

公開第二稿は、仕様固定アンカーを再証明するのではなく、推定レイヤーの観測・推定指標がどの条件で支持、非支持、沈黙になるかを扱う。
