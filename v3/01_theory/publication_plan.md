...
現時点の本文候補は `22_public_second_draft.md` に置く。このファイルは `notes/21_public_second_draft_outline.md` の章立てを本文化したものであり、まだ新しい支持判定や実験結果を追加するものではない。旧アウトラインは保管メモとして残すが、現役の読者導線ではない。
