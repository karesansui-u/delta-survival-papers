...
4. small specification-fixed operational anchors: the finite-PMF first-moment collapse bound \(\Pr[Z>0]\le\mathbb E[Z]\), the BEC erasure-rank accounting identity \(L_E=a(E)\log 2\), and the finite converse that \(|E|>r\) precludes unique recovery.
