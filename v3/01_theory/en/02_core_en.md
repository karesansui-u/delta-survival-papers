...
4. small specification-fixed operational anchors: the finite-PMF first-moment collapse bound \(\Pr[Z>0]\le\mathbb E[Z]\), the BEC erasure-rank accounting identity \(L_E=a(E)\log 2\), the finite converse that \(|E|>r\) precludes unique recovery, the random parity-check row-slack envelope, and the BEC erasure-count concentration bridge.
