...
This file gives the operational reading of support labels used in v3.
...
| externally supported | support decision reproduced by fresh archive, future surface, outside rerun, or independent runner |
| no-support | frozen support rule failed |
| weak-axis failure | proposed SP axis duplicates the baseline or target leakage |
| silence | required observability is absent; the theory should not speak |
