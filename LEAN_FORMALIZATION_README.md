...
- current imported development size: `172 Survival modules`
...
- the formalization covers the core structural-persistence framework,
  ...
  control and software-evidence instantiations, a stack-level epistemic-control
  entry point, and information-theoretic bridges
