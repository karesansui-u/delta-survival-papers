...
- current imported development size: `170 Survival modules`
...
- the formalization covers the core structural-persistence framework,
  ...
  wrappers, epistemic-control and evidence-packet bridges, toy LLM and
  software-evidence instantiations, and information-theoretic bridges
