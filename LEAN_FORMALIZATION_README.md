...
- current imported development size: `169 Survival modules`
...
- the formalization covers the core structural-persistence framework,
  ...
  wrappers, epistemic-control and evidence-packet bridges, a toy
  software-evidence instantiation, and information-theoretic bridges
