...
The weak-dependence formalization comprises dedicated Lean~4 components for sandwich bounds, correlated second-moment analysis, and robust survival estimation, including an LLM bridge via $\delta$ interval estimation from per-constraint loss ranges.
