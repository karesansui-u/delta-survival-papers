...
\paragraph{Testable prediction.} The $P = 1/(1 + K/L)$ model with $K \approx 20$ (in units of thousands of tokens) predicts: at $L = 512\text{K}$, $P(\text{correct}) \approx 0.96$; at $L = 1\text{M}$, $P(\text{correct}) \approx 0.98$. These are directly verifiable in future context-length extension experiments.
