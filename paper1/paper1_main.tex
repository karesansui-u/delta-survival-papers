...
The survival equation's connection to information theory extends beyond shared vocabulary (nats, self-information) to three formal results that close the gap between the survival framework and Shannon's theorems.
