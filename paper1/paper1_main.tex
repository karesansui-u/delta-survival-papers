...
Exp.~35 provides an experimental deconfounding. Under $\delta = 0$ (zero structural contradiction), five high-capability models across four vendors maintain \emph{perfect} accuracy up to 128{,}000 tokens (150{,}000 Claude-internal tokens)---no degradation whatsoever. Under $\delta > 0$, accuracy collapses immediately at 500 tokens. The causal variable is contradiction content, not sequence length.
