...
\item \textbf{Formal verification}: 419 Lean~4 modules, zero \texttt{sorry}/\texttt{admit}/\texttt{axiom}, with conditional bridges to 60+ fields and target-relative repair-affordability readouts (\S\ref{sec:lean}).
\end{enumerate}
...
The formalization comprises 419 modules (with \texttt{sorry}~$=0$, \texttt{admit}~$=0$, \texttt{axiom}~$=0$). Lean~4 v4.26.0 + Mathlib v4.26.0.
