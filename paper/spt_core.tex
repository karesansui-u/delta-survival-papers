...
\item \textbf{Formal verification}: 414 Lean~4 modules, zero sorry/admit/axiom, with conditional bridges to 60+ fields, a theorem map separating formal claims from non-claims, and a bundled \texttt{MLDomain} layer for persistence-facing projections of several major theories (\S\ref{sec:lean}).
\end{enumerate}
...
414 modules, 3{,}578 build jobs. sorry~$= 0$, admit~$= 0$, axiom~$= 0$. Lean~4 v4.26.0 + Mathlib v4.26.0. Repository: \url{https://github.com/karesansui-u/persistence-lean}.
