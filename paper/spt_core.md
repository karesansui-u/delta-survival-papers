...
- Of the ~426 modules, approximately 20 are **Tier A** (core-routed, with non-trivial conclusions). Approximately 160 are **Tier C** (vocabulary mappings, not theorems). The mathematical weight is concentrated in Tier A and the core.
...
The ~426 modules include cross-domain bridges at three tiers:
...
426 modules. 3,590 build jobs. sorry = 0. admit = 0. axiom = 0.
