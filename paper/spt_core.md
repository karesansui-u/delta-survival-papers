...
- Of the ~423 modules, approximately 20 are **Tier A** (core-routed, with non-trivial conclusions). Approximately 160 are **Tier C** (vocabulary mappings, not theorems). The mathematical weight is concentrated in Tier A and the core.
...
The ~423 modules include cross-domain bridges at three tiers:
...
423 modules. 3,587 build jobs. sorry = 0. admit = 0. axiom = 0.
