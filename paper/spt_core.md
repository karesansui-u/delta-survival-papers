...
- **Information-theoretic certificates, not Shannon coding theorem**: The BSC and finite-block layers connect retransmission profiles and finite-block achievability/obstruction certificates to M/L affordability. They do not formalize an asymptotic Shannon coding theorem, capacity-achieving construction, or strong converse.
