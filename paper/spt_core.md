...
- Of the ~424 modules, approximately 20 are **Tier A** (core-routed, with non-trivial conclusions). Approximately 160 are **Tier C** (vocabulary mappings, not theorems). The mathematical weight is concentrated in Tier A and the core.
...
The ~424 modules include cross-domain bridges at three tiers:
...
424 modules. 3,588 build jobs. sorry = 0. admit = 0. axiom = 0.
