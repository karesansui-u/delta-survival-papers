...
BUNDLES = {
    "main-spine-only": {
        ...
        "parts": [
            ("v2/3_構造持続の収支法則と崩壊傾向.md", "Main Theory Spine: Paper 3"),
    ...
    "full-theory-with-supplements": {
        ...
        "parts": [
            ...
            ("v2/補論_構造収支律とFoster-Lyapunovドリフトの形式的埋め込み.md", "Supplement: Foster-Lyapunov Embedding"),
            ("v2/補論_構造持続における資源項Mの操作的定式化.md", "Supplement: M Operationalization"),
            ("v2/補論_非CSP古典例における構造収支律の最小アンカー.md", "Supplement: Non-CSP Classical Anchors"),
